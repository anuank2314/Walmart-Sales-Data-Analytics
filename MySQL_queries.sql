...
-- Find minimum and maximum quantity sold
...
-- Q5: Identify the monthly sales trend
SELECT 
...
-- Q7: Calculate the total profit for each category
SELECT 
    category,
...
-- Q9: Which categories should Walmart promote more to increase profitability?
SELECT 
    category,
...
FROM walmart
GROUP BY category
ORDER BY avg_profit_margin DESC, total_sales ASC;
